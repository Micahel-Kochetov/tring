...
public class NPBinding : SingletonPattern <NPBinding>
{
	...
	private		static VoxelBusters.NativePlugins.Utility 				utility;
	...
	/// </summary>
	public static VoxelBusters.NativePlugins.Utility Utility 		
	{ 
		get
		{
			NPBinding	_sharedInstance	= NPBinding.Instance;
			...
			if (utility == null)
				utility	= _sharedInstance.CachedGameObject.AddComponentIfNotFound<VoxelBusters.NativePlugins.Utility>();
	...
	protected override void Init ()
	{
		...
		if (utility == null)
			utility			= CachedGameObject.AddComponentIfNotFound<VoxelBusters.NativePlugins.Utility>();
