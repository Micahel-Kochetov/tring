...
namespace VoxelBusters.ReplayKit.Common.Utility
{
    public partial class AndroidManifestGenerator
    {
        ...
        public void SaveManifest(string _packageName, string _path, string _versionCode, string _versionName, string _minSDKVersion, string _targetSDKVersion)
        {
            ...
            using (XmlWriter _xmlWriter = XmlWriter.Create(_path, _settings))
            {
                _xmlWriter.WriteStartDocument();
                {
                    ...
                    WriteAttributeString(_xmlWriter, "xmlns", "tools", null, "http://schemas.android.com/tools");
        ...
        protected void WriteUsesPermission(XmlWriter _xmlWriter, string _name, string _toolsOption = null, Feature[] _features = null, string _comment = null)
        {
            if (_comment != null)
                _xmlWriter.WriteComment(_comment);
            ...
            {
                WriteAttributeString(_xmlWriter, "android", "name", null, _name);
                if(_toolsOption != null)
                {
                    WriteAttributeString(_xmlWriter, "tools", "remove", null, _toolsOption);
                }
            }
            _xmlWriter.WriteEndElement();
