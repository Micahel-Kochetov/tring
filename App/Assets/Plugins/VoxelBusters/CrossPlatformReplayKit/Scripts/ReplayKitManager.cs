...
namespace VoxelBusters.ReplayKit
{
    ...
    public class ReplayKitManager
    {
        ...
        public static void Initialise()
        {
            ...
            ReplayKitInternal.Instance.DidRecordingStateChangeEvent -= OnRecordingStateChangedHandler;
            ReplayKitInternal.Instance.DidRecordingStateChangeEvent += OnRecordingStateChangedHandler;

            ReplayKitInternal.Instance.Initialise();
        }

        private static void OnRecordingStateChangedHandler(ReplayKitRecordingState state, string message)
        {
